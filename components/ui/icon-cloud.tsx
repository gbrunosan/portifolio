...
export function IconCloud({ icons, images, className, width = 400, height = 400, iconSize = 40 }: IconCloudProps) {
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      iconPositions.forEach((icon, index) => {
        ...
        ctx.save()
        ctx.translate(width / 2 + rotatedX, height / 2 + rotatedY)
  ...
  }, [icons, images, iconPositions, isDragging, mousePos, targetRotation, width, height, iconSize])
